...
[![Latest Stable Release](https://img.shields.io/github/v/release/pkgforge-dev/Fretboard-AppImage)](https://github.com/pkgforge-dev/Fretboard-AppImage/releases/latest)
